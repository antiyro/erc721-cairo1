...
trait IERC721Preset3 {
    fn constructor(name_: felt252, symbol_: felt252, max_supply: u128, max_date: u64);
    fn mint(to: ContractAddress, token_id: u256);
}
...
trait IERC721Receiver {
    fn on_erc721_received(
        operator: ContractAddress, from_: ContractAddress, token_id: u256, data: Array::<felt252>
    ) -> felt252;
}
