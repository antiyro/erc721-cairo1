...
mod ERC721Preset2Contract {
    ...
    use src::libraries::ERC721Preset2Library;
    use src::libraries::ERC721Preset2Library::ERC721Preset2Impl;
    ...
    fn constructor(
        ...
        IERC721Preset2::constructor(name_, symbol_, max_supply, max_date, whitelited_collection_);
    }
